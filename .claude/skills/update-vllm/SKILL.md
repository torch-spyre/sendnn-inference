...
Upgrade this plugin to vLLM `$ARGUMENTS`. The procedure below is the distilled checklist; it has produced clean upgrades for past patch releases (0.20.1, 0.20.2, 0.21.0) and surfaced the right compat shims for breaking releases (0.20.0, 0.10.1).
